...
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Wolox/fd-maquetado?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Error Tracking](https://d26gfdfi90p7cf.cloudfront.net/rollbar-badge.144534.o.png)](https://rollbar.com)

`[![Codestats](http://codestats-url/organizations/your-organization/projects/fd-maquetado/badge)](http://codestats-url/organizations/your-organization/projects/fd-maquetado/badge)`
...
- Clone the repository by running `git clone git@github.com:Wolox/fd-maquetado.git`
- Go to the project root by running `cd fd-maquetado`
...
```bash
  ...
  CREATE ROLE "fd-maquetado" LOGIN CREATEDB PASSWORD 'fd-maquetado';
```
